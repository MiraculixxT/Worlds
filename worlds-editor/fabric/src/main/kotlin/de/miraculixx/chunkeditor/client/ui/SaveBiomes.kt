        ...
        withContext(Dispatchers.IO) {
            ...
            try {
                ...
                val registry = resources.use { resources ->
                    ...
                    val context = TagLoader.buildUpdatedLookups(layers.getAccessForLoading(RegistryLayer.WORLDGEN), staticTags)
                    RegistryDataLoader.load(resources, context, RegistryDataLoader.WORLDGEN_REGISTRIES, Util.backgroundExecutor())
