...
object FabricNet : Transport {
    ...
    fun register() {
        PayloadTypeRegistry.playC2S().register(EditorPacket.C2S_TYPE, EditorPacket.C2S_CODEC)
        PayloadTypeRegistry.playS2C().register(EditorPacket.S2C_TYPE, EditorPacket.S2C_CODEC)
